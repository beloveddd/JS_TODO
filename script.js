import { INPUT, BTN_PLUS, MODAL, LIST_OF_TASKS, BTN_ALL, BTN_ACTIVE, BTN_COMPLITED, BTN_CLEAR_COMPLITED, BTN_SORT, BTN_DATE_SORT, BTN_NAME_SORT, TASK_PROPERTIES, BTN_FILTER, FILTER_INPUT } from "./const.js";
import { addTaskToList, defineTarget, showAllTasks, showActiveTasks, showCompletedTasks, clearCompletedTasks, showSortWindow, sortByProperty, checkFilterInput, getValueFromFilterInput } from "./functions.js";
...
BTN_FILTER.addEventListener('click', checkFilterInput);
FILTER_INPUT.addEventListener('blur', getValueFromFilterInput);
